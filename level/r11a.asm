...
; -------------------------------------------------------------------------------
	...
	; MMD header. If the file is to be loaded and run at the start Word RAM, then
	; this should be left blank.
	dc.w	0					; File load flags
	dc.l	0					; File load destination
	dc.w	0					; Size of file
...
; -------------------------------------------------------------------------------
	...
	include	"level/unused/leftover.asm"
...
; -------------------------------------------------------------------------------
	...
	include	"level/unused/leftover2.asm"
